...
```
  -b, --batch-mode                   Runs in batch mode without prompting for user input
      --chart-dir string             the directory to look for helm charts if no .jx/kube-test/settings.yaml file is found (default "charts")
  ...
  -d, --dir string                   the directory to look for helm, helmfile or kustomize files (default ".")
      ...
      --helm-version string          specifies the helm version to use. If not specified we download the plugin (default "3.5.3")
  -h, --help                         help for run
      ...
      --kubeval-version string       specifies the kubeval version to use. If not specified we download the plugin (default "0.16.1")
  ...
  -r, --recurse                      should we recurse through the chart dir to find charts if no .jx/kube-test/settings.yaml file is found (default true)
